...
$query = "SELECT rezerwacje.id, ksiazki.tytul, ksiazki.opis, ksiazki.img_src, rezerwacje.data_wygasniecia, rezerwacje.id_ksiazka, rezerwacje.id_uzytkownik from ksiazki inner join rezerwacje on ksiazki.id = rezerwacje.id_ksiazka where CURRENT_DATE > rezerwacje.data_wygasniecia and id_uzytkownik = $userid;";
            ...
            <div class="nav-links">
                ...
                if ($isLoggedIn) {
                    echo '
                            ...
                            <a href="hisreserv.php" class="nav-link nav-active">
